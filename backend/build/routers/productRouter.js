...
exports.productRouter.get('/kategorie', (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const kategorie = yield productModel_1.ProductModel.find().distinct('kategorie');
    res.json(kategorie);
})));
// /api/slug/tshirt
